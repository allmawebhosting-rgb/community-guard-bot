...
import { AlertTriangle, Bell, Clock, MapPin, RefreshCw } from "lucide-react";
      ...
      <div className="mx-auto w-full max-w-6xl px-5 pt-6 pb-6 lg:px-10 lg:pt-8">
        ...
        {isLoading ? (
          ...
          <div className="rounded-[2rem] border border-destructive/25 bg-destructive/5 p-16 text-center">
            ...
            <p className="mt-4 font-display text-lg font-bold">Alerts could not be loaded</p>
            <p className="mt-2 text-[13px] text-muted-foreground">
              Check your connection and try again. Emergency SOS remains available below.
            </p>
            <button
              type="button"
