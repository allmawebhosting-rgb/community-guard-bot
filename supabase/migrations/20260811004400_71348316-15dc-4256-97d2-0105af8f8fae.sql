...
grant select, insert, update, delete on public.authority_directory to authenticated;
grant all on public.authority_directory to service_role;
grant select, insert, update on public.authority_notifications to authenticated;
grant all on public.authority_notifications to service_role;
grant select, insert on public.authority_escalations to authenticated;
grant all on public.authority_escalations to service_role;
