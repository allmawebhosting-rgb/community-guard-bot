-- Return the caller identity and location only when the recipient granted access
-- and the SOS actually captured coordinates.
...
AS $$
  SELECT
    ...
    END,
    sc.share_location_on_sos IS TRUE
